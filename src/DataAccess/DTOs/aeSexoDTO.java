...
public class aeSexoDTO {
    ...
    public aeSexoDTO(String nombre, String descripcion) {
        this.idCatalogoTipo = 1; // Sexo
        this.idCatalogo = 0; // nuevo registro
        this.nombre = nombre;
    ...
    public aeSexoDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String descripcion, String estado,
