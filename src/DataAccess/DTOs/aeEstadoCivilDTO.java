...
public class aeEstadoCivilDTO {
    ...
    public aeEstadoCivilDTO(){}

    public aeEstadoCivilDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String descripcion, String estado,
